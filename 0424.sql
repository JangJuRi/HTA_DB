...
values
('JuRi', 'zxcv1234', '장주리', 'wkdwnfl119@naver.com', 10, sysdate);
...
-- 컬럼명을 생략한 경우
-- 반드시 테이블의 컬럼순서에 맞게 모든 값을 나열해야한다.
insert into sample_book_users
values
...
(user_id, user_password, user_name)
values
('dalchong', 'zxcv1234', '김수한무거북이와두루미삼천갑자동박삭김수한무거북이와두루미삼천갑자동박삭');
...
-- 서브쿼리를 이용해서 값 변경하기
-- 132번 직원의 급여를 소속부서(50번 부서)의 평균급여로 변경하기
update employees
set
...
insert into sample_book_users
values('kkang', 'zxcv1234', '강감찬', 'kang1111@gmail.com', 100, sysdate);
